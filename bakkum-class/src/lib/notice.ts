...
export type NoticeAudience = "all" | "staff" | "students" | "elem" | "mid";
...
const ALL: NoticeAudience[] = ["all", "staff", "students", "elem", "mid"];
...
/** 이 공지/배너가 보는 사람에게 노출되는가. 학생이면 band(elem/mid/bridge)로 더 거른다. */
export function noticeVisible(audience: string, opts: { isStudent: boolean; band?: string }): boolean {
