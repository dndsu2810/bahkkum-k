// SVG icons ported verbatim from the prototype. Stroke width is set via CSS.
...
const paths: Record<string, ReactNode> = {
  ...
  sparkle: <path d="M12 3l1.9 5.6a2 2 0 0 0 1.5 1.3L21 11l-5.6 1.1a2 2 0 0 0-1.5 1.3L12 19l-1.9-5.6a2 2 0 0 0-1.5-1.3L3 11l5.6-1.1a2 2 0 0 0 1.5-1.3z" />,
  clock: (
    <>
