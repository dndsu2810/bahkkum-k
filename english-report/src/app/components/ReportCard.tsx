...
import { Download, Calendar, ChevronDown, GraduationCap, Image, Award, Printer } from 'lucide-react';
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div id="export-area" ref={reportRef} className="bg-white shadow-2xl rounded-3xl overflow-hidden border-2 border-gray-100 print:rounded-lg print:shadow-none print:border-0">
        ...
        <div className="bg-gradient-to-br from-[#E3F2FD] to-[#BBDEFB] px-6 py-3 print:px-2 print:py-1 border-b border-[#2196F3]">
          <div className="flex items-center justify-between gap-4 print:gap-2 text-sm print:text-[10px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 print:grid-cols-2">
          ...
          <div className="border-r-2 border-gray-200">
            ...
            <div className="bg-gradient-to-r from-[#BBDEFB] to-[#90CAF9] px-4 py-3 print:px-2 print:py-1.5 border-b-2 border-[#2196F3]">
              <h3 className="text-center text-gray-800 text-sm print:text-[10px] tracking-wide">Categorized Evaluation: Overall Academics</h3>
            </div>

            {/* Table Header */}
            <div className="grid grid-cols-[3fr_1fr_2fr] bg-gradient-to-r from-[#E3F2FD] to-[#BBDEFB] border-b-2 border-[#90CAF9]">
              <div className="px-4 py-3 print:px-2 print:py-1 text-xs print:text-[9px] text-[#1565C0] uppercase tracking-wider">Criteria</div>
              <div className="px-3 py-3 print:px-1 print:py-1 text-center text-xs print:text-[9px] text-[#1565C0] uppercase tracking-wider border-l-2 border-white">Score</div>
              <div className="px-3 py-3 print:px-1 print:py-1 text-center text-xs print:text-[9px] text-[#1565C0] uppercase tracking-wider border-l-2 border-white">Grade</div>
            </div>
              ...
              {student.evaluations.map((item, index) => (
                <div key={index} className="grid grid-cols-[3fr_1fr_2fr] hover:bg-blue-50/70 transition-colors group">
                  <div className="px-4 py-3 print:px-2 print:py-1">
                    <div className="text-gray-900 text-sm print:text-[10px]">{item.criteria}</div>
                    <div className="text-xs print:text-[8px] text-gray-500 mt-0.5 print:mt-0">{item.criteriaKo}</div>
                  </div>
                  <div className="px-3 py-3 print:px-1 print:py-1 text-center border-l-2 border-gray-100 flex items-center justify-center">
                    <span className="inline-flex items-center justify-center w-12 h-12 print:w-7 print:h-7 bg-gradient-to-br from-[#2196F3] to-[#1976D2] text-white rounded-xl print:rounded-md text-sm print:text-[9px] shadow-md">
                      {item.score}
                    </span>
                  </div>
                  <div className="px-3 py-3 print:px-1 print:py-1 text-center border-l-2 border-gray-100 flex items-center justify-center">
                    <span className="text-xs print:text-[8px] text-gray-700">{item.grade}</span>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-gradient-to-br from-[#E3F2FD] to-[#BBDEFB]">
            <div className="px-4 py-3 print:px-2 print:py-1.5 bg-gradient-to-r from-[#BBDEFB] to-[#90CAF9] border-b-2 border-[#2196F3]">
              <h3 className="text-center text-gray-800 text-sm print:text-[10px] tracking-wide">Point Spread Analysis</h3>
            </div>
            <div className="flex items-center justify-center p-6 print:p-2">
              ...
              >
                ...
                <PolarAngleAxis 
                  dataKey="subject" 
                  tick={{ fill: '#1565C0', fontSize: 9, fontWeight: 600 }}
                  tickLine={false}
                />
                <PolarRadiusAxis 
                  angle={90} 
                  domain={[0, 6]}
                  tick={{ fill: '#1976D2', fontSize: 8, fontWeight: 600 }}
        ...
        <div className="bg-gradient-to-r from-[#1976D2] to-[#2196F3] text-white px-6 py-3 print:px-2 print:py-1 border-t-2 border-[#1565C0]">
          <div className="text-center mb-2 print:mb-0.5 text-xs print:text-[7px] uppercase tracking-widest opacity-95">Grading Scale</div>
          <div className="flex flex-wrap justify-center gap-2 print:gap-1 text-xs print:text-[8px]">
            <div className="flex items-center gap-1.5 print:gap-0.5 bg-white/15 px-2 py-1.5 print:px-1.5 print:py-0.5 rounded-lg print:rounded-md backdrop-blur-sm border border-white/20">
              <span className="w-6 h-6 print:w-4 print:h-4 bg-white/25 rounded-lg print:rounded-md flex items-center justify-center text-xs print:text-[8px]">P</span>
              <span>Perfect</span>
            </div>
            <div className="flex items-center gap-1.5 print:gap-0.5 bg-white/15 px-2 py-1.5 print:px-1.5 print:py-0.5 rounded-lg print:rounded-md backdrop-blur-sm border border-white/20">
              <span className="w-6 h-6 print:w-4 print:h-4 bg-white/25 rounded-lg print:rounded-md flex items-center justify-center text-xs print:text-[8px]">E</span>
              <span>Excellent</span>
            </div>
            <div className="flex items-center gap-1.5 print:gap-0.5 bg-white/15 px-2 py-1.5 print:px-1.5 print:py-0.5 rounded-lg print:rounded-md backdrop-blur-sm border border-white/20">
              <span className="w-6 h-6 print:w-4 print:h-4 bg-white/25 rounded-lg print:rounded-md flex items-center justify-center text-xs print:text-[8px]">GR</span>
              <span>Great</span>
            </div>
            <div className="flex items-center gap-1.5 print:gap-0.5 bg-white/15 px-2 py-1.5 print:px-1.5 print:py-0.5 rounded-lg print:rounded-md backdrop-blur-sm border border-white/20">
              <span className="w-6 h-6 print:w-4 print:h-4 bg-white/25 rounded-lg print:rounded-md flex items-center justify-center text-xs print:text-[8px]">G</span>
              <span>Good</span>
            </div>
            <div className="flex items-center gap-1.5 print:gap-0.5 bg-white/15 px-2 py-1.5 print:px-1.5 print:py-0.5 rounded-lg print:rounded-md backdrop-blur-sm border border-white/20">
              <span className="w-6 h-6 print:w-4 print:h-4 bg-white/25 rounded-lg print:rounded-md flex items-center justify-center text-xs print:text-[8px]">VG</span>
              <span>Very Good</span>
            </div>
            <div className="flex items-center gap-1.5 print:gap-0.5 bg-white/15 px-2 py-1.5 print:px-1.5 print:py-0.5 rounded-lg print:rounded-md backdrop-blur-sm border border-white/20">
              <span className="w-6 h-6 print:w-4 print:h-4 bg-white/25 rounded-lg print:rounded-md flex items-center justify-center text-xs print:text-[8px]">NI</span>
        ...
        <div className="border-t-2 border-gray-200">
          <div className="bg-gradient-to-r from-[#BBDEFB] to-[#90CAF9] px-4 py-2 print:px-2 print:py-0.5 border-b-2 border-[#2196F3]">
            <h3 className="text-center text-gray-800 text-sm print:text-[9px] tracking-wide">Teacher's Comments</h3>
          </div>
          <div className="bg-gradient-to-br from-[#E1F5FE] to-[#B3E5FC] px-6 py-3 print:px-2 print:py-1 min-h-[60px] print:min-h-[30px]">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl print:rounded-md p-3 print:p-1.5 border-2 border-white shadow-lg">
              <p className="text-gray-800 leading-relaxed text-sm print:text-[9px] print:leading-tight">{student.comments}</p>
            </div>
          </div>
        </div>
